...
#  install.packages("data.table", "rms", "mgcv") # Watch out, rms loads a lot of other packages. skipping for now.
  library(data.table)
  library(reshape2)
  library(survival)
  library(ggplot2)
...
* $N_k$ is the number of individuals at-risk for mortality while under observation at distrinct ranked event time $R_k$ for $k = 1, \ldots, D^{\prime}$.
